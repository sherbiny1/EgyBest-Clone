...
export default function Trending({ themeChange, theme }) {
  ...
  <main className="grid-cols-12 grid px-55 py-10">
    <aside className="col-span-2 border-gray-400/30 border-2 dark:bg-gray-700">
        <ul className="bg-gray-100 space-y-4 p-2 *:bg-gray-200 dark:bg-gray-700">
    ...
    <section className="col-span-10 border-gray-400/30 p-4 border-2">
        <Outlet/>
    </section>
  </main>
  </>
